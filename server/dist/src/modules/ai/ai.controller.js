...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Send a message to LifeMate AI' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get AI chat sessions' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get messages in a session' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
