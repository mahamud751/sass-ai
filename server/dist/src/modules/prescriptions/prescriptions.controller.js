...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create prescription with medicine items for a patient' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List prescriptions (filter by patient/family member)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get prescription with all medicine items' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Post)(':id/auto-add-medicines'),
    (0, swagger_1.ApiOperation)({ summary: 'Auto-create medicine reminders for all prescription items' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], PrescriptionsController.prototype, "autoAddMedicines", null);
__decorate([
    (0, common_1.Post)(':id/items/:itemId/add-medicine'),
    (0, swagger_1.ApiOperation)({ summary: 'Create medicine reminder from a single prescription item' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], PrescriptionsController.prototype, "addMedicineFromItem", null);
